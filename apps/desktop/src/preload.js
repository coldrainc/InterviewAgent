...
contextBridge.exposeInMainWorld("interviewAgent", {
  ...
  reviewSite: {
    listPlans: () => ipcRenderer.invoke("review-site:plans"),
    ...
    listWrongBook: () => ipcRenderer.invoke("review-site:wrong-book"),
    runImport: (payload) => ipcRenderer.invoke("review-site:import", payload),
  ...
  listEvalRuns: () => ipcRenderer.invoke("eval-runs:list"),
  listAgentTraces: () => ipcRenderer.invoke("ops:traces"),
