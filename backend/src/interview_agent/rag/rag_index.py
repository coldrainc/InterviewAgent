...
from interview_agent.rag.knowledge_types import KnowledgeChunk
from interview_agent.rag.vector_store import JsonVectorStore, VectorStore
...
class PersistentRagIndex:
    ...
    def _hybrid_scores(
        ...
        from interview_agent.embeddings.embedding import cosine_similarity
        ...
        for chunk in candidates.values():
            ...
            hybrid_score = 0.55 * vector_score + 0.45 * sparse_score
